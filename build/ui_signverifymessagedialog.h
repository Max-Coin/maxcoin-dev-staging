...
public:
    ...
    QValidatedLineEdit *pubkeyOut_SM;
    ...
    QValidatedLineEdit *pubkeyIn_VM;
    ...
    void setupUi(QDialog *SignVerifyMessageDialog)
    {
        ...
        pubkeyOut_SM = new QValidatedLineEdit(tabSignMessage);
        pubkeyOut_SM->setObjectName(QStringLiteral("pubkeyOut_SM"));
        pubkeyOut_SM->setMaxLength(130);

        verticalLayout_SM->addWidget(pubkeyOut_SM);
        ...
        pubkeyIn_VM = new QValidatedLineEdit(tabVerifyMessage);
        pubkeyIn_VM->setObjectName(QStringLiteral("pubkeyIn_VM"));
        pubkeyIn_VM->setMaxLength(130);

        verticalLayout_VM->addWidget(pubkeyIn_VM);
    ...
    void retranslateUi(QDialog *SignVerifyMessageDialog)
    {
        ...
        addressIn_SM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "The address to sign the message with (e.g. mNS17iag9jJgTHD1VXjvLCEnZuQ3rJDE9L)", nullptr));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        pubkeyOut_SM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "The public key used to sign the message", nullptr));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        signMessageButton_SM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "Sign the message to prove you own this MaxCoin address", nullptr));
#endif // QT_NO_TOOLTIP
        ...
        infoLabel_VM->setText(QApplication::translate("SignVerifyMessageDialog", "Enter the message (ensure you copy line breaks, spaces, tabs, etc. exactly), signing public key and signature below to verify the message. Be careful not to read more into the signature than what is in the signed message itself, to avoid being tricked by a man-in-the-middle attack.", nullptr));
#ifndef QT_NO_TOOLTIP
        pubkeyIn_VM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "The public key used to sign the message", nullptr));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        verifyMessageButton_VM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "Verify the message to ensure it was signed with the specified MaxCoin address", nullptr));
#endif // QT_NO_TOOLTIP
